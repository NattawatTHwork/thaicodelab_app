  ...
  },
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        route: "#",
        children: [
          { label: "Borrow", route: "/equipment_transactions/borrow", permission: 55 },
          { label: "Return", route: "/equipment_transactions/return", permission: 56 },
          { label: "Status", route: "/equipment_transactions/status", permission: 57 },
          { label: "Transactions", route: "/equipment_transactions/transaction", permission: 59 },
        ],
      },
    ],
  },
