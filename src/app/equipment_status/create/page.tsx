...
const EquipmentStatusCreate = () => {
    ...
    try {
      ...
      if (response.ok) {
        Swal.fire({
          icon: "success",
          title: "Success",
          text: "Equipment status has been created successfully!",
        });
        setFormData({
          equipment_status: ""
        });
  ...
  return (
    <DefaultLayout>
      ...
      <Breadcrumb pageName={["Equipment Management", "Equipment Status", "Equipment Status Create"]} />
...
export default EquipmentStatusCreate;
