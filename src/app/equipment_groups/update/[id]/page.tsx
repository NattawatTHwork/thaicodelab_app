...
const EquipmentGroupUpdate = ({ params }: { params: { id: string } }) => {
      ...
      try {
        ...
        if (response.ok && result.status) {
          const mappedFormData = {
            equipment_group_code: result.data.equipment_group_code,
            equipment_group: result.data.equipment_group,
    ...
    try {
      ...
      if (response.ok) {
        Swal.fire({
          icon: "success",
          title: "Success",
          text: "Equipment group has been updated successfully!",
        });
        fetchData();
      } else {
        Swal.fire({
  ...
  return (
    <DefaultLayout>
      ...
      <Breadcrumb pageName={["Equipment Management", "Equipment Groups", "Equipment Group Update"]} />
                ...
                <form action="#">
                  <div className="mb-5.5">
                    ...
                    <div className="relative">
                      <input
                        ...
                        value={formData.equipment_group_code}
                  ...
                  <div className="flex justify-end gap-4.5">
                    <button
                      ...
                      type="button"
                      onClick={() => setFormData({
                        equipment_group_code: formData.equipment_group_code,
                        equipment_group: "",
                        department_id: ""
                      })}
                    >
