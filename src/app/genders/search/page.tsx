...
const GenderSearch = () => {
  ...
  return (
    <DefaultLayout>
      ...
      <Breadcrumb pageName={["User Management", "Genders", "Gender Search"]} />
                          ...
                          <td className="px-6 py-4 text-center relative">
                            ...
                            {dropdownOpen === gender.gender_id && (
                              <div className="absolute right-0 top-full mt-2 w-40 bg-white border rounded shadow-md z-10 whitespace-nowrap">
                                {userPermissions.includes(27) && <Link href={`/genders/detail/${gender.gender_id}`}><button className="block w-full px-4 py-2 text-left hover:bg-gray-200">View</button></Link>}
                                {userPermissions.includes(28) && <Link href={`/genders/update/${gender.gender_id}`}><button className="block w-full px-4 py-2 text-left hover:bg-gray-200">Update</button></Link>}
                                {userPermissions.includes(29) && <button onClick={() => handleDelete(gender.gender_id, gender.gender_code)} className="block w-full px-4 py-2 text-left text-red-600 hover:bg-gray-200">Delete</button>}
                              </div>
                            )}
                          </td>
                        </tr>
