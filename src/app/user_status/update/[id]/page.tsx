...
const UserStatusUpdate = ({ params }: { params: { id: string } }) => {
      ...
      try {
        ...
        if (response.ok && result.status) {
          const mappedFormData = {
            user_status_code: result.data.user_status_code,
            user_status: result.data.user_status,
            description: result.data.description,
          };
          setFormData(mappedFormData);
        } else {
          console.error("Error fetching user_statuss:", result.message);
        }
      } catch (error) {
        console.error("Error fetching user_statuss:", error);
      }
    }
  };
                ...
                <form action="#">
                  <div className="mb-5.5">
                    ...
                    <div className="relative">
                      <input
                        ...
                        id="user_status_code"
                        value={formData.user_status_code}
                  ...
                  <div className="flex justify-end gap-4.5">
                    <button
                      ...
                      type="button"
                      onClick={() => setFormData({
                        user_status_code: formData.user_status_code,
                        user_status: ""
                      })}
                    >
                      Clear
