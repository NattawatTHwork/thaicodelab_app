...
const EquipmentDetail = ({ params }: { params: { id: string } }) => {
                  ...
                  <div className="mb-5.5">
                    ...
                    <div className="relative">
                      <input
                        ...
                        name="equipment_code"
                        id="equipment_code"
                        value={equipmentData.equipment_code}
                        readOnly
                      />
                    </div>
                  </div>
                  ...
                  <div className="mb-5.5">
                    ...
                    <div className="relative">
                      <input
                        ...
                        value={equipmentData.equipment_group}
                        readOnly
                      />
                    </div>
                  </div>
                  ...
                  <div className="mb-5.5">
                    ...
                    <div className="relative">
                      <input
                        ...
                        id="equipment_status"
                        value={equipmentData.equipment_status}
                        readOnly
                      />
                    </div>
                  </div>
