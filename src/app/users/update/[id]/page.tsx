...
const UserUpdate = ({ params }: { params: { id: string } }) => {
      ...
      try {
        ...
        if (response.ok && result.status) {
          const mappedFormData = {
            rank_id: result.data.rank_id.toString(),
            firstname: result.data.firstname,
            lastname: result.data.lastname,
            email: result.data.email,
            phone_number: result.data.phone_number,
            birthdate: result.data.birthdate,
            gender_id: result.data.gender_id.toString(),
            role_id: result.data.role_id.toString(),
            department_id: result.data.department_id.toString(),
            user_status_id: result.data.user_status_id.toString(),
          };
  ...
  return (
    <DefaultLayout>
      ...
      <Breadcrumb pageName={["User Management", "Users", "User Update"]} />
