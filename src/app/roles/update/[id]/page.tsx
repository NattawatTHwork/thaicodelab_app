...
const RoleUpdate = ({ params }: { params: { id: string } }) => {
  ...
  const fetchData = async () => {
    if (session?.user?.token) {
      try {
        const response = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/role/${id}`, {
          method: "GET",
          headers: {
  ...
  return (
    <DefaultLayout>
      ...
      <Breadcrumb pageName={["User Management", "Roles", "Role Update"]} />
